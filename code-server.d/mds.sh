...
conName="code-server-netsuite"

# You must specify a container image.
#conImg="codercom/code-server:v2"
conImg="$conName"
...
#args+=" -v ${HOME}/.local/share/code-server/project:/home/coder/project"
#args+=" -v ${HOME}/.local/share/code-server/share:/home/coder/.local/share/code-server"
...
#function postconfig() {
  ...
  #docker run $conName --install-extension "nsupload-org.netsuite-upload"
