...
conName="libreofficeOnline"

# You must specify a container image.
conImg="libreoffice/online:master"
...
args="-d"
args+=" -p 9101:9980"
args+=" -e domain=nextcloud.reaves.dev"
args+=" -e username=libreoffice"
args+=" -e password=libreoffice"
args+=" -e extra_params='--o:ssl.enable=false'"
