...
args+=" -e LDAP_ORGANISATION=Homelab"
args+=" -e LDAP_DOMAIN=reaves.dev"
args+=" -e LDAP_ADMIN_PASSWORD=$password"
args+=" -e LDAP_OPENLDAP_UID=1001"
args+=" -e LDAP_OPENLDAP_GID=1001"
args+=" -v /mnt/VMStorage/LDAP/ldap:/var/lib/ldap"
args+=" -v /mnt/VMStorage/LDAP/slapd.d:/etc/ldap/slapd.d"
