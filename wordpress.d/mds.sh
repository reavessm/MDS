...
conImg="wordpress"
#conImg="wordpress:5.2.3-php7.2-fpm-alpine"
...
args+=" -p 8102:80"
args+=" -v /mnt/VMStorage/Wordpress:/var/www/html"
#args+=" -e WORDPRESS_DB_HOST=localhost"
args+=" -e WORDPRESS_DB_USER=wordpress"
args+=" -e WORDPRESS_DB_PASSWORD=password"
args+=" -e WORDPRESS_DB_NAME=wordpress"
args+=" -e WORDPRESS_TABLE_PREFIX=wp_"
