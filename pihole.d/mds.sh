...
args+=" -e WEBPASSWORD=Gamecocks14"
args+=" -e DNS1=208.67.222.123"
args+=" -e DNS2=208.67.220.123"
args+=" -v /mnt/VMStorage/PiHole/PiHole:/etc/pihole"
args+=" -v /mnt/VMStorage/PiHole/DNSMASQ:/etc/dnsmasq.d"
